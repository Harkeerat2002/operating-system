...
struct thread
  {
    ...
    bool waiting;                       /* True if waiting for a child */
    bool parent_waiting;                /* True if parent is waiting */
    bool is_loaded;                     /* True if process is loaded in memory */
    struct list children;               /* List of a thread's children to store its information */
#endif
...
void latest_cpu(struct thread * t, void * aux);

...
/* Blocks a thread and sets the wakeUpTick of the current thread to the passed in parameter.*/
...
/* Scans the sleeping list, and checks if the timmer has expired or not. If it has then it unblocks it and removes it from the list*/
